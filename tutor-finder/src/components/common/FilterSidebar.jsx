            ...
            <div className="bg-white rounded-2xl shadow-soft border border-gray-100 p-6">
              ...
              <FilterSection title="Distance" section="distance">
                <select
                  ...
                  className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm"
                >
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm"
                        min="0"
                      />
                    </div>
                    <div className="flex-1">
